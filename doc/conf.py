...
# hence building doc would fail for 3.9 <= python < 3.11
# parsing version manually using regex
# Future refactor when requiring python>=3.11: use tomllib to get version
import re
...
version_line = re.compile(r'version = ".+"').findall(content)[0]
...
html_theme_options = {
    ...
    # TODO: put svg icons in a separate file
    "footer_icons": [
        {
            "name": "Discord",
            "url": "https://discord.com/invite/R7EsDBf3eN",
            "html": """
        ...
        },
        {
            ...
            "html": """
                <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 16 16" style='margin-left: 1em;'>
...
# sphinx-copybutton.readthedocs.io/en/latest/use.html#using-regexp-prompt-identifiers
...
latex_documents = [
    (
        master_doc,
        "skillner.tex",
        "skillner Documentation",
        "Anas AIT AOMAR & Badr MOUFAD",
        "manual",
    ),
]
...
man_pages = [(master_doc, "skillner", "skillner Documentation", [author], 1)]
