# a copy/past of NLTK PorterStemmer class with slight modifications
...
class PorterStemmer:
    ...
    def __init__(self, to_lowercase=True, mode=NLTK_EXTENSIONS):
        if mode not in (
    ...
    def stem(self, word: Word):
        ...
        """
        stem = word.lower() if self.to_lowercase else word
    ...
    def _is_consonant(self, word, i):
        """Return True if word[i] is a consonant, False otherwise.
    ...
    def _measure(self, stem):
        r"""Return the 'measure' of stem, per definition in the paper.
    ...
    def _contains_vowel(self, stem):
        """Return True if stem contains a vowel, else False."""
        for i in range(len(stem)):
    ...
    def _ends_double_consonant(self, word):
        """Implement condition *d from the paper.
    ...
    def _ends_cvc(self, word):
        """Implement condition *o from the paper.
    ...
    def _replace_suffix(self, word, suffix, replacement):
        """Replace `suffix` of `word` with `replacement`."""
    ...
    def _apply_rule_list(self, word, rules):
        """Apply the first applicable suffix-removal rule to the word.
    ...
    def _step1a(self, word):
        """Implement Step 1a from "An algorithm for suffix stripping".
    ...
    def _step1b(self, word):
        """Implement Step 1b from "An algorithm for suffix stripping".
    ...
    def _step1c(self, word):
        """Implement Step 1c from "An algorithm for suffix stripping".
    ...
    def _step2(self, word):
        """Implement Step 2 from "An algorithm for suffix stripping".
    ...
    def _step3(self, word):
        """Implement Step 3 from "An algorithm for suffix stripping".
    ...
    def _step4(self, word):
        """Implement Step 4 from "An algorithm for suffix stripping".
        ...
        tidying up.
        """
        measure_gt_1 = lambda stem: self._measure(stem) > 1  # noqa
    ...
    def _step5a(self, word):
        """Implement Step 5a from "An algorithm for suffix stripping".
