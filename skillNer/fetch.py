...
client_id = "5f379hywuvh7fvan" # replace 'your_client_id' with your client id from your api invite email
...
def fetch_skills_list() -> pd.DataFrame:
    ...
    auth = f"Authorization: Bearer {access_token}" # Auth string including access token from above
